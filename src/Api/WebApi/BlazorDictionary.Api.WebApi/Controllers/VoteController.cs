...
namespace BlazorDictionary.Api.WebApi.Controllers
{
    ...
    public class VoteController : BaseController
    {
        ...
        {
            await _mediator.Send(new DeleteEntryCommentVoteCommand(entryId, UserId.Value));
        ...
        {
            await _mediator.Send(new DeleteEntryVoteCommand(entryCommentId, UserId.Value));
